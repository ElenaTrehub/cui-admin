...
namespace Application\Core\About\templates\template2;
...
class AboutTemplate2
{
    ...
    public function setUniqueStyle($styleString, $htmlString, $jsString, $colors, $fonts, $set, $id){
        ...
        if($obj->set->theme == 'normal'){
            $obj = $this->setColorStyle($obj, $colors, $fonts);
        }
        else if($obj->set->theme == 'light'){
            $obj = $this->setLightColorStyle($obj, $colors, $fonts);
        }
        else {
            $obj = $this->setDarkColorStyle($obj, $colors, $fonts);
        }
