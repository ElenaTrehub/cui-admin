...
{
//    public function getFontSizeStyle($fonts){
//        return '.h1{font-size: '.$fonts->h1Size.'; }.h2{font-size: '.$fonts->h2Size.'; }.h3{font-size: '.$fonts->h3Size.'; }.h4{font-size: '.$fonts->h4Size.'; }.textSize{font-size: '.$fonts->textSize.'; }.linkSize{font-size: '.$fonts->linkSize.'; }.bigSize{font-size: '.$fonts->bigSize.'; }';
//
//    }
    public function getGlobalStyle($fonts, $spaces, $colors){
        ...
        $titleStr = '.title{font-weight:'.$titleWeight[$indexWeight].'; text-transform: '.$textTransform[$index].'; padding-bottom: '.$spaces->titleBottomSpace.';}';
        $titleLightColor = '.title-light{color: '.$colors->titleColor.';}';
        $titleDarkColor = '.title-dark{color: '.$colors->linkColor.';}';

        //$fontSizeStr = '.h1{font-size: '.$fonts->h1Size.'; }.h2{font-size: '.$fonts->h2Size.'; }.h3{font-size: '.$fonts->h3Size.'; }.h4{font-size: '.$fonts->h4Size.'; }.textSize{font-size: '.$fonts->textSize.'; }.linkSize{font-size: '.$fonts->linkSize.'; }.bigSize{font-size: '.$fonts->bigSize.'; }';
