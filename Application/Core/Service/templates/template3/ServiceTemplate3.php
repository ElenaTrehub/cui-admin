...
namespace Application\Core\Service\templates\template3;
...
class ServiceTemplate3
{
    ...
    public function setColorsForChildInLightBlock($obj, $colors){
        ...
        if(strpos($obj->style, '/*service_num_c*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_num_c*/', 'color: '.$colors->titleColor.';');
        }
        if(strpos($obj->style, '/*service_num_after_bg*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_num_after_bg*/', 'background-color:#ffffff;');
        }
        if(strpos($obj->style, '/*service_num_after_border*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_num_after_border*/', 'border: 5px solid'.$colors->titleColor.';');
        }
        if(strpos($obj->style, '/*service_num_line_bg*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_num_line_bg*/', 'background-color: #d8cdc2;');
        }
    ...
    public function setColorsForChildInDarkBlock($obj, $colors){
        ...
        if(strpos($obj->style, '/*service_num_c*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_num_c*/', 'color: '.$colors->anyTextColor.';');
        }
        if(strpos($obj->style, '/*service_num_after_bg*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_num_after_bg*/', 'background-color:'.$colors->linkColor.';');
        }
        if(strpos($obj->style, '/*service_num_after_border*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_num_after_border*/', 'border: 5px solid'.$colors->anyTextColor.';');
        }
        if(strpos($obj->style, '/*service_num_line_bg*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_num_line_bg*/', 'background-color: #a6a0a4;');
        }
        if(strpos($obj->style, '/*ser_c_content*/',0)!==false){
