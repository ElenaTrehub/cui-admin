...
namespace Application\Core\Blocks\Service\templates\template2;
...
class ServiceTemplate2
{
    ...
    public function setPhoto($obj, $id){
        if(strpos($obj->html, '<!--im_service_1-->',0)!==false){
            $obj->html = $this->utilsService->parseStyle($obj->html, '<!--im_service_1-->', '<img src="../images/'.$this->settings->getPhotoFolderName($id).'/service-1.jpg" alt="about">');
        }
        return $obj;
    }
    ...
    public function setColorsForChildInLightBlock($obj, $colors){
        ...
        if(strpos($obj->style, '/*service_head_c*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_head_c*/', 'color: '.$colors->textColor.';');
        }
        if(strpos($obj->style, '/*service_head_c_before*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_head_c_before*/', 'color: '.$colors->titleColor.';');
        }
        if(strpos($obj->style, '/*service_head_c_active*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_head_c_active*/', 'color: '.$colors->titleColor.';');
        }
        ...
        if(strpos($obj->style, '/*service_head_border_c*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_head_border_c*/', 'border-bottom: 1px solid '.$colors->anyTextColor.';');
        }
        if(strpos($obj->style, '/*service_head_border_top_c*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_head_border_top_c*/', 'border-top: 1px solid '.$colors->anyTextColor.';');
        }
        if(strpos($obj->style, '/*service_text_border_c*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_text_border_c*/', 'border-bottom: 1px solid '.$colors->anyTextColor.';');
        }
    ...
    public function setColorsForChildInDarkBlock($obj, $colors){
        ...
        if(strpos($obj->style, '/*service_head_c*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_head_c*/', 'color: '.$colors->linkColor.';');
        }
        if(strpos($obj->style, '/*service_head_c_before*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_head_c_before*/', 'color: '.$colors->anyTextColor.';');
        }
        if(strpos($obj->style, '/*service_head_c_active*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*service_head_c_active*/', 'color: '.$colors->anyTextColor.';');
        }
        if(strpos($obj->style, '/*service_t_c*/',0)!==false){
