...
namespace Application\Core\Blocks\Feature\templates\template1;
...
class FeatureTemplate1
{
    ...
    public function setColorsForChildInLightBlock($obj, $colors){
        ...
        if(strpos($obj->style, '/*f_t_span_c*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*f_t_span_c*/', 'color: '.$colors->anyTextColor.';');
        }
        ...
        if(strpos($obj->style, '/*f_text_border*/',0)!==false){
            $obj->style = $this->utilsService->parseStyle($obj->style, '/*f_text_border*/', 'border-left: 2px solid '.$colors->anyTextColor.';');
        }
    }
