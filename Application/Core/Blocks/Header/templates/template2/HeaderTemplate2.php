...
namespace Application\Core\Blocks\Header\templates\template2;
        ...
        if(strpos($obj->style, '/*h_t_bg*/',0)!==false){
                ...
                if($index < 2){
                    ...
                    if(strpos($obj->style, '/*header_icon_c*/',0)!==false){
                        $obj->style = $this->utilsService->parseStyle($obj->style, '/*header_icon_c*/', 'color: '.$colors->lincColor.';');
    ...
    public function setLightColorStyle($obj, $colors){
        ...
        if(strpos($obj->style, '/*h_t_bg*/',0)!==false){
            ...
            if($index < 1){
                ...
                if(strpos($obj->style, '/*header_icon_c*/',0)!==false){
                    $obj->style = $this->utilsService->parseStyle($obj->style, '/*header_icon_c*/', 'color: '.$colors->mainBg.';');
    ...
    public function setDarkColorStyle($obj, $colors){
        ...
        if(strpos($obj->style, '/*h_t_bg*/',0)!==false){
            ...
            if($index < 1){
                ...
                if(strpos($obj->style, '/*header_icon_c*/',0)!==false){
                    $obj->style = $this->utilsService->parseStyle($obj->style, '/*header_icon_c*/', 'color: #ffffff;');
